...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Verifique se os elementos necessários existem antes de adicionar event listeners
    if (addChallengeBtn && challengesList && challengeMessage && addLearningBtn && learningsList && learningMessage) {
        ...
        console.error("Erro: Alguns elementos essenciais não foram encontrados no DOM.");
    }
});
